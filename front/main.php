...
<script>
  ...
  function sliders(){
    ...
    <div class="half">
      ...
      // $row=$Movie->all(['sh'=>1]," AND ondate <= '$today' AND ondate >= '$ondate'");
        ...
        <div style="display:flex;flex-wrap:wrap;">
          ...
          <div class="movie-item">
            ...
            <div style="width:calc(100% - 65px);">
              ...
              <div>分級：
                <img src="./icon/03C0<?=$row['level']; ?>.png" style="width:20px;vertical-align:middle;"></div>
